          ...
          <div class="hero_section">
            <div class="row">
              ...
              <div class="col-lg-7 col-sm-5">
                  {!! Html::image('assets/img/'.$page->images,'',array('class'=>'zoomIn wow animated')) !!}
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="{{$page->alias}}"><!--Aboutus-->
      <div class="inner_wrapper">
        ...
        <div class="row">
          ...
          <div class="work_bottom"> <span>Want to know more..</span> <a href="{{route('page', array('alias'=>$page->alias))}}" class="contact_btn" >About Us</a> </div>       
              </div> 
            </div>  
          </div>
        </div> 
